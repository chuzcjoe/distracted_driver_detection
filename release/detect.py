...
class Detection:
    def __init__(self):
        ...
        parser.add_argument('--cfg_name', default='cfg/ssd_tinyvgg_coverLP_320x256_newcleandata.yml', type=str,
        					help='Trained state_dict file path to open')
        parser.add_argument('--job_group', default='rfbnet', type=str,
        					help='Directory for saving checkpoint models')
        parser.add_argument('--trained_model', default='weight/ssd_tinyvgg_coverLP_320x256_newcleandata_80000.pth', type=str,
        					help='Trained state_dict file path to open')
