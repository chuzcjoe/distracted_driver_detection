...
def match(threshold, truths, priors, variances, labels, loc_t, conf_t, idx,
    ...
    #prior need by mimic 
    mimic_label = labels[best_truth_idx] + 1 
    mimic_label[:]=0
    mimic_label[best_truth_overlap > threshold] = 1
    # for i in range(len(mimic_label)):
    #     if mimic_label[i] > 0:
    #         print('22222',mimic_label[i])
    mimic_label_t[idx]=mimic_label
    # priors_mimic = list()
    # for i,flag in enumerate (best_truth_overlap > threshold):
    #     if flag != 0:
    #         priors_mimic.append(priors[i,:])
    # print(len(priors_mimic))
    # print('bbbbbbb',priors_mimic)
    # priors_mimic_t[idx] = (best_truth_overlap > threshold)
